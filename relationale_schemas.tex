...
\end{equation}
Ein anderes Wort für eine Relation wäre in der Datenbankwelt eine Tabelle. 
...
Eine Tabelle besteht aus vielen Tupeln, welche alle dieselben Attribute haben. Diese Attribute müssen eindeutig benennt sein.
